...
const Detail = () => {
  ...
  return (
    ...
    <div css={css`overflow: hidden;`}>
      ...
      <MobileView>
        <div css={css`width: 335px; margin-top: 45px; overflow: hidden; font-family: NanumSquare; color: #241E19; margin-bottom: 40px;`}>
        ...
        {modalVisible && <DetailSuggestModal modalVisible={modalVisible} setModalVisible={setModalVisible} clubID={clubInfo.club.clubId} toastVisible={toastVisible} setToastVisible={setToastVisible}/>}
          ...
          <table css={mobileSummaryTable}>
              <tbody>
                <tr>
                  <td css={mobileCategoryTD}>분야</td><td css={mobileDataTD}>{clubInfo.club.mainCategory}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td css={mobileCategoryTD}>활동 기간</td><td css={mobileDataTD}>{clubInfo.club.period}</td>
                </tr>
                <tr>
                  <td css={mobileCategoryTD}>정기 요일</td><td css={mobileDataTD}>{clubInfo.club.activityDay}</td>
                </tr>
                <tr>
                  <td css={mobileCategoryTD}>회비</td><td css={mobileDataTD}>{clubInfo.club.membershipFee}</td>
                </tr>
                <tr>
                  <td css={mobileCategoryTD}>선발 절차</td><td css={mobileDataTD}>{clubInfo.club.selectionProcess}</td>
                </tr>
                <tr>
                  <td css={css`border-right: 1px solid #DBDBDB; text-align: center; background: #F8F8F8;`}>활동 방법</td>
                  <td css={css`text-align: center`}>
                    {
                      clubInfo.club.online == 1
                      ? <div>온라인</div>
          ...
          <div css={css`width: 100%; display: flex; justify-content: space-between; margin-bottom: 29px;`}>
            <div css={css`
            font-weight: 400;
            font-size: 12px;
          ...
          <div css={mobileDetailContent}>
            ...
            <div css={mobileDetailDescription}>
              <div css={css`display: flex; margin-bottom: 14px;`}>
                <img src={siteIcon} css={css`width: 13px; height: 13px; margin-right: 9px;`}/>
                <a href={clubInfo.club.siteAddress} css={css`color: #241E19;`}>{clubInfo.club.siteAddress}</a>
              </div>
              <div css={css`display: flex;`}>
                <img src={snsIcon} css={css`width: 13px; height: 13px; margin-right: 9px;`}/>
                <a href={clubInfo.club.snsAddress} css={css`color: #241E19;`}>{clubInfo.club.snsAddress}</a>
              </div>
            </div>
            ...
            <div css={mobileDetailDescription} style={{display: 'flex', marginBottom: '0px'}}>
              {
                clubInfo.recommendClub.map((a) => {
                  return(
                    <a href={`/detail/${a.clubId}`} css={css`text-decoration: none`}>
