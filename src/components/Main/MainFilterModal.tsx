        ...
        >
            ...
            >
              {FieldFilterDataset.map((filterObj: string, index: number) => {
                return (
                  <FilterSelected
                    className={
                      fieldFilter.includes(filterObj)
                        ? "selected"
                        : "notSelected"
                    }
                    onClick={() =>
                      onClickFilter(filterObj, fieldFilter, setFieldFilter)
                    }
                  >
                    {filterObj}
                  </FilterSelected>
          ...
          <>
            ...
            <div
              ...
              `}
            >
              {RecruitingFilterDataset.map(
                (filterObj: string, index: number) => {
                  return (
                    <FilterSelected
                      className={
                        recruitingFilter.includes(filterObj)
                          ? "selected"
                          : "notSelected"
                      }
                      onClick={() =>
            ...
            >
              {PeriodFilterDataset.map((filterObj: string, index: number) => {
                return (
                  <FilterSelected
                    className={
                      periodFilter.includes(filterObj)
                        ? "selected"
                        : "notSelected"
                    }
                    onClick={() =>
                      onClickFilter(filterObj, periodFilter, setPeriodFilter)
                    }
                  >
                    {filterObj}
                  </FilterSelected>
            ...
            >
              {ActivityDayDataset.map((filterObj: string, index: number) => {
                return (
                  <FilterSelected
                    className={
                      activityDayFilter.includes(filterObj)
                        ? "selected"
                        : "notSelected"
                    }
                    onClick={() =>
            ...
            >
              {OnlineDataset.map((filterObj: string, index: number) => {
                return (
                  <FilterSelected
                    className={
                      onlineFilter.includes(filterObj)
                        ? "selected"
                        : "notSelected"
                    }
                    onClick={() =>
                      onClickFilter(filterObj, onlineFilter, setOnlineFilter)
                    }
                  >
                    {filterObj}
                  </FilterSelected>
